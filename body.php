    ...
    <div class="container">
      <div class="row py-5">
        <div class="col">
          ...
          <p>Mi nombre es
            <?php print ($arreglobjeto[nombres].' '. $arreglobjeto[apellidos]);?> tengo <?php print ($arreglobjeto[edad]);?> años, mi signo es <?php print ($arreglobjeto[signo]);?> y mi animal favorito es <?php print ($arreglobjeto[animal]);?>.
           </p>
          <ul>
